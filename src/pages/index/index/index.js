 ...
 */
  ...
  render () {
    ...
    //图片列表
    var img_arr = { style: 'style1' }
    if (this.state.img_arr) {
      img_arr = this.state.img_arr
    }
    console.log(img_arr)
    //商品列表
    var goods_arr = { style: 'style1' }
    if (this.state.goods_arr) {
      goods_arr = this.state.goods_arr
    }
    //文章列表
    var article_arr = { style: 'style1' }
    ...
    return (
      <View className='index'>            
        <Search></Search>
        <Slide show_style={slide_img_arr['style'] } slide_img_arr={slide_data}></Slide>
        <MagicSquare show_style={magic_arr['style']} magic_arr={magic_data}></MagicSquare>        
        <ImageList show_style={img_arr['style']} hid_title={false} img_arr={img_data_arr} img_title={img_title}></ImageList>
        <GoodsList show_style={goods_arr['style']} goods_arr={goods_data_arr}></GoodsList>
        <ArticleList show_style={article_arr['style']} hid_title={false} article_arr={article_data_arr}></ArticleList>   
