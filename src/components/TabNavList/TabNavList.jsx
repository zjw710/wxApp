...
export default class TabNavList extends Component {
    ...
    render() {
        ...
        if (sel_tab == 0) {
            goods_list = <GoodsList show_style={'style2'} hid_title={true}></GoodsList>
        } else if (sel_tab == 1) {
            goods_list = <GoodsList show_style={'style3'} hid_title={true}></GoodsList>
        }else{
            goods_list = <GoodsList show_style={'style1'} hid_title={true}></GoodsList>
        }                
